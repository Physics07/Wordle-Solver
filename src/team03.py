...
class Solver:
    ...
    def choose_next_guess(self, problem_id, turn):
        ...
        prompt = (
            "I'm playing Wordle and guessed a word, and got a feedback for my guess. Based on the following feedback, my guess and the rules for the result string, return the result string generated by this feedback.\n"
            f"My Guess: {' '.join(self.previous_guess[problem_id])}\n"
            f"Feedback: {history[-1]}\n\n"
            "The result string is computed as follows:\n"
            "1. If the two words have the same letter at the i-th (1 ≤ i ≤ 5) position, the corresponding letter in the result string is 'B'.\n"
